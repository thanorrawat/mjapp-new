...
<div class="tab-content card-block">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-bordered" id="willorder">
          ...
          <th>NAME</th>
          <th>UNIT</th> 
<?php $__currentLoopData = $montharr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$('#willorder').DataTable({
  processing: true,
    serverSide: true,
    "ajax":{
    "url": "<?php echo e(url("purchase/will_order_data")); ?>",
    "type": "GET",
    "data":{ csrf: "<?php echo e(csrf_token()); ?>",ordertype : "booking"}
