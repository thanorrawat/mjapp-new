...
<?php $__env->startSection('title',  __('file.Customer List')); ?>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($customer->id); ?>">
                    ...
                    <td>
                        ...
                        <a href="<?php echo e(route('customer.edit', ['id' => $customer->id])); ?>" class="btn btn-out btn-sm btn-warning"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                        <?php echo e(Form::open(['route' => ['customer.destroy', $customer->id], 'method' => 'DELETE', 'style'=>'display:inline'] )); ?>
