<nav class="pcoded-navbar">
    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li><a href="<?php echo e(url("order")); ?>"> <span class="pcoded-micon"><i class="dripicons-basket"></i></span><?php echo e(__('file.Add Order')); ?></a></li>
...
<li class="pcoded-hasmenu  <?php if(url()->current() == url('/purchases') ||url()->current() == url('/purchases/create')|| url()->current() == url('purchases/purchase_by_csv') || url()->current() == url('report/daily_purchase/'.date('Y').'/'.date('m'))|| url()->current() == url('report/monthly_purchase/'.date('Y')) ): ?>pcoded-trigger active  <?php endif; ?>">
    ...
    <ul class="pcoded-submenu">
        ...
        <li  <?php if(url()->current() == url('report/daily_purchase/'.date('Y').'/'.date('m'))): ?> class="active" <?php endif; ?> >
            <a href="<?php echo e(url('report/daily_purchase/'.date('Y').'/'.date('m'))); ?>">
                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                <span class="pcoded-mtext" ><?php echo e(trans('file.Daily Purchase')); ?></span>
                <span class="pcoded-mcaret"></span>
            </a>
        </li>

        <li  <?php if(url()->current() == url('report/monthly_purchase/'.date('Y'))): ?> class="active" <?php endif; ?> >
            <a href="<?php echo e(url('report/monthly_purchase/'.date('Y'))); ?>">
                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                <span class="pcoded-mtext" ><?php echo e(trans('file.Monthly Purchase')); ?></span>
                <span class="pcoded-mcaret"></span>
            </a>
        </li>
      ...
      <li  <?php if(url()->current() == url('purchases/purchase_by_csv')): ?> class="active" <?php endif; ?> >
          <a href="<?php echo e(url('purchases/purchase_by_csv')); ?>">
              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
              <span class="pcoded-mtext" ><?php echo e(trans('file.Import Purchase By CSV')); ?></span>
              <span class="pcoded-mcaret"></span>
          </a>
      </li>
    </ul>
