...
<?php if(Auth::user()->role_id!=9): ?>
    ...
    <li class="nav-item ">
      ...
      <p><?php echo e(__('file.Memo Edit Price')); ?></p></a>
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo e(url('/purchases')); ?>" class="nav-link <?php if(url()->current() == url('/purchases') ): ?>  active <?php endif; ?>">
                <i class="far fa-circle nav-icon"></i>
                <p><?php echo e(trans('file.Purchase Order')); ?></p>
              </a>
            </li>
...
<li  class="nav-item has-treeview <?php if(url()->current() == route('supplier.index') || url()->current() == route('supplier.create')): ?> active <?php endif; ?>" >
    ...
    <?php if(Auth::user()->role_id==9){  ?>
      ...
      <li  class="nav-item" >
        <a href="<?php echo e(url('supplier/purchase-orders')); ?>" class="nav-link <?php if(url()->current() == url('supplier/purchase-orders')): ?> active <?php endif; ?>">
        <i class="nav-icon fas fa-file-invoice"></i>
        <p><?php echo e(__('file.Purchase Order')); ?></p></a>
        </li>
        
<li  class="nav-item" >
  <a href="<?php echo e(url('supplier/shipment-list')); ?>" class="nav-link <?php if(url()->current() == url('supplier/shipment-list')): ?> active <?php endif; ?>">
