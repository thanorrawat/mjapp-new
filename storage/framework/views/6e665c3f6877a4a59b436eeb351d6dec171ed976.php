...
<?php $__env->startSection('title',  __('file.Supplier List')); ?> <?php $__env->startSection('content'); ?>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($supplier->id); ?>">
                    ...
                    <td>
                        ...
                        <?php echo e(Form::open(['route' => ['supplier.destroy', $supplier->id], 'method' => 'DELETE' , 'style'=>'border:solid gray 1px'] )); ?>
