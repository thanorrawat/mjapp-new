...
<?php $__env->startSection('title',  __('file.Add Customer')); ?> 
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.Customer Code')); ?> *</strong> </label>
                                    <input type="text" name="customercode" value="<?php echo e($lims_customer_data->customercode); ?>" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.Price Group')); ?> </label>
                           

                                    <select required class="form-control selectpicker" name="price_group">
                                      
                                            <option <?php if($lims_customer_data->price_group=='A'): ?> selected  <?php endif; ?>
                                             value="A">Standard A</option>

                                             <option <?php if($lims_customer_data->price_group=='B'): ?> selected  <?php endif; ?>
                                                value="B">Standard B</option>


                                                <option <?php if($lims_customer_data->price_group=='C'): ?> selected  <?php endif; ?>
                                                    value="C">Standard C</option>

                                                    <option <?php if($lims_customer_data->price_group=='D'): ?> selected  <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout-theme-gradient-able.app', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>