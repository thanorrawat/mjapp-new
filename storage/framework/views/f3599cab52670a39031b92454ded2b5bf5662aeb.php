...
<head>
    ...
    <title><?php echo e($orderdt->bookingnumber); ?></title>
...
<body>
   ...
   <td></td>
            ...
            <td width="150"><?php echo e($orderdt->bookingnumber); ?></td>
...
<table  style="width:750px; margin: auto;">
    ...
    <tr>
<td style="width: 70px"><strong>ผู้ขออนุมัติจอง</strong></td>
<td style="border-bottom: 1px dotted #000"><?php echo e($orderdt->createby_name); ?></td>
<td align="right" style="width: 80px"><strong>ผู้รับจอง</strong></td>
