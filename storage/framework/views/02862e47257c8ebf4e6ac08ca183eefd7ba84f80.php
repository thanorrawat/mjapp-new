...
<div class="brand-text float-left ">
    ...
    <div class="row" >
          ...
          <div class="col-md-6 col-xl-3">
            ...
            <memo-price baseurl="<?php echo e(url('/')); ?>"  userfullname="<?php echo e(Auth::user()->fullname); ?>" userid="<?php echo e(Auth::user()->id); ?>" csrf="<?php echo e(csrf_token()); ?>" role_id="<?php echo e(Auth::user()->role_id); ?>"></memo-price>
    ...
    <div class="col-md-6 col-xl-3">
        ...
        <div class="card">
          <div class="card-header border-transparent">
            <h3 class="card-title"><?php echo e(__('file.Order_Wait_for_continue')); ?> </h3>
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header border-transparent">
            <h3 class="card-title"><?php echo e(__('file.Booking_Wait_for_continue')); ?> </h3>
...
<script>
  ...
  "type": "GET",
  "data":{ csrf: "<?php echo e(csrf_token()); ?>",ordertype : "order",approved : 2}
...
$('#bookingnotapprove').DataTable({
  ...
  "url": "<?php echo e(url("orderdata")); ?>",
  "type": "GET",
  "data":{ csrf: "<?php echo e(csrf_token()); ?>",ordertype : "booking",approved : 2}
