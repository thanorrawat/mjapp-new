...
<li  class="nav-item has-treeview @if(url()->current() == route('supplier.index') || url()->current() == route('supplier.create')) active @endif" >
    ...
    <?php if(Auth::user()->role_id==9){  ?>
      ...
      <li  class="nav-item" >
        <a href="{{url('supplier/purchase-orders')}}" class="nav-link @if(url()->current() == url('supplier/purchase-orders')) active @endif">
        <i class="nav-icon fas fa-file-invoice"></i>
        <p>{{ __('file.Purchase Order') }}</p></a>
        </li>
        
<li  class="nav-item" >
  <a href="{{url('supplier/shipment-list')}}" class="nav-link @if(url()->current() == url('supplier/shipment-list')) active @endif">
