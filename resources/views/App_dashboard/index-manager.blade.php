...
<div class="brand-text float-left ">
  ...
  {{-- ใบจองรออนุมัติ --}}
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header border-transparent">
            <h3 class="card-title">{{ __('file.Booking Wait for approval') }} </h3>
      ...
      <div id="product-details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        ...
        <memo-price baseurl="{{ url('/') }}"  userfullname="{{  Auth::user()->fullname }}" userid="{{  Auth::user()->id }}" csrf="{{ csrf_token() }}" role_id="{{ Auth::user()->role_id }}" homepage="1"></memo-price>
</div>
...
<script>
  ...
  "url": "{{ url("orderdata") }}",
  "type": "GET",
  "data":{ csrf: "{{ csrf_token() }}",ordertype : "order",approved : 1}
...
$('#bookingnotapprove').DataTable({
  ...
  "url": "{{ url("orderdata") }}",
  "type": "GET",
  "data":{ csrf: "{{ csrf_token() }}",ordertype : "booking",approved : 1}
