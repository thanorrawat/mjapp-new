...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('public/logo/mj.png')  }}" />
    <!-- Bootstrap CSS-->
...
.login-page, .register-page{
        background-image: url("{{ asset('public/images/mj/login.jpg')  }}");
      ...
      <div class="container">
        <div class="form-outer d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-center "><img src="{{  asset('public/images/mj/logo-mj.png') }}" alt="{{$general_setting->site_title}}"><span>{{$general_setting->site_title}}</span></div>
           ...
           <p class="text-center "><a href="{{ route('password.request') }}" class="forgot-pass">{{trans('file.Forgot Password?')}}</a></p> 
            
            {{-- <p>{{trans('file.Do not have an account?')}}</p><a href="{{url('register')}}" class="signup">{{trans('file.Register')}}</a> --}}
          </div>
          <div class="copyrights text-center">
            <p>{{trans('file.Developed By')}} Techhive</p>
