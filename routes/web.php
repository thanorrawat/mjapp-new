...
Route::get('so_view/{id}','Api\Socontroller@soview'); //แสดงรายการสินค้า จาก orderid
	...
	///supplier admin.
	Route::get('polistforcheckdata', 'Mj\SupplierAdminController@polistforcheck');
	Route::get('supplier/purchase-orders', 'Mj\SupplierAdminController@purchaseorder');
	Route::post('polistupdate', 'Mj\SupplierAdminController@polistupdate');
	Route::get('supplier/purchase/{id}/edit', 'Mj\SupplierAdminController@purchaseorderedit');
	Route::post('supplier/purchase-update', 'Mj\SupplierAdminController@updatepo');
	Route::get('supplier/shipment-list', function () {
		return view('App_supplier.shipmentlist');
	});
	Route::get('supplier/shipmentlistdata', 'Mj\SupplierAdminController@shipmentlist');

	Route::get('supplier/shipment/{id}/edit', 'Mj\SupplierAdminController@shipmentedit');
	...
	Route::get('category/category-data', 'CategoryController@categoryData');
	...
	Route::get('products/product-data', 'ProductController@productData');
	...
	Route::get('productstracking/{id}', 'ProductController@producttracking');
	...
	Route::post('delete_product_cart', 'CartController@destroy');
	Route::post('updatecartdetials', 'CartController@updatecartdetials');
...
Route::get('order_cartlist', function () {
	return view('App_sale.order_cartlist');
});

Route::post('create_order', 'OrderController@carttoorder');
Route::post('edit_order', 'OrderController@edit_order');


Route::get('order/{id}', 'OrderController@orderdetails');
Route::get('order_input/{id}', 'OrderController@orderinput');
Route::get('booking/{id}', 'OrderController@orderdetails');

Route::get('ordertest', 'OrderController@test');

Route::get('orderlistedit/{id}', 'OrderController@orderedit');

Route::post('addtoorder', 'OrderController@addtoorder');
Route::post('delete_product_order', 'OrderController@destroy');
Route::post('checkstockorder', 'OrderController@checkstockorder');
...
Route::get('order_list', function () {
	return view('App_order.orderlist');
});
Route::get('booking_list', function () {
	return view('App_order.bookinglist');
});
...
Route::get('notify', 'AppLineController@notify');
...
/// old route
	...
	//Route::get('sales/sale-data', 'SaleController@saleData');
