...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        if($role->hasPermissionTo('users-index')){
            ...
            return view('App_user.index', compact('lims_user_list', 'all_permission'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('users-add')){
            ...
            return view('App_user.create', compact('lims_role_list', 'lims_biller_list', 'lims_warehouse_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $imageName = date("YmdHis").$imageName . '.' . $ext;
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('users-edit')){
            ...
            $lims_biller_list = Biller::where('is_active', true)->get();
            $lims_warehouse_list = Warehouse::where('is_active', true)->get();
            return view('App_user.edit', compact('lims_user_data', 'lims_role_list', 'lims_biller_list', 'lims_warehouse_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!empty($request['password']))
            ...
            if(!empty($request->oldimage) && !empty($request->deloldimage)){
    ...
    {
        $lims_user_data = User::find($id);
        return view('App_user.profile', compact('lims_user_data'));
    }
