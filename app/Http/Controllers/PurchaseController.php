...
class PurchaseController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('purchases-index')){            
            ...
            return view('App_purchase.index', compact('lims_purchase_list', 'lims_account_list', 'all_permission', 'lims_pos_setting_data'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('purchases-add')){
            ...
            return view('App_purchase.create', compact('lims_supplier_list', 'lims_warehouse_list', 'lims_tax_list', 'lims_product_list_without_variant', 'lims_product_list_with_variant'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function purchaseByCsv()
    {
        ...
        if($role->hasPermissionTo('purchases-add')){
            ...
            return view('App_purchase.import', compact('lims_supplier_list', 'lims_warehouse_list', 'lims_tax_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
