...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        return view('App_category.create',compact('lims_categories', 'lims_category_all'));
    }
    ...
    public function categoryData(Request $request)
    {
      ...
      if($_GET['csrf']==csrf_token()) {
        ...
        ->addColumn('action', function ($categories) {
            ...
            return ' <button type="button" data-id="'.$categories->id.'" class="open-EditCategoryDialog btn btn-out btn-sm btn-warning" data-toggle="modal" data-target="#editModal" ><i class="dripicons-document-edit"></i> '.trans("file.edit").'</button>
            
            '.\Form::open(["route" => ["category.destroy", $categories->id], "method" => "DELETE","class"=>"d-inline"] ).'
                               
                                  <button onclick="return confirm(\''.trans("file.confirm delete").'\');" type="submit" class="btn btn-out btn-sm btn-danger" ><i class="dripicons-trash"></i> '.trans("file.delete").'</button> 
                                '.\Form::close();
        })
    ...
    public function categoryData(Request $request)
    {
        ...
        if(!empty($categories))
        {
            ...
            {
                $nestedData['number'] = $category->number;
                $nestedData['key'] = $key;
                $nestedData['name'] = $category->name;
                $nestedData['cate_type'] = $category->cate_type;
                $nestedData['code'] = $category->code;
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $lims_category_data['code'] = $request->code;
        $lims_category_data['cate_type'] = $request->cate_type;  
        $lims_category_data['parent_id'] = $request->parent_id;
        $lims_category_data['description'] = $request->description;
    ...
    public function import(Request $request)
    {
        ...
        while($columns=fgetcsv($file))
        {
            ...
            $category = Category::firstOrNew(['code' => $data['code'], 'is_active' => true ]);
            ...
            $category->cate_type= $data['catetype'];
