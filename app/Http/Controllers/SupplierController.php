...
class SupplierController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('suppliers-index')){
            ...
            return view('App_supplier.index',compact('lims_supplier_all', 'all_permission'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('suppliers-add')){
            return view('App_supplier.create');
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('suppliers-edit')){
            ...
            return view('App_supplier.edit',compact('lims_supplier_data'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
