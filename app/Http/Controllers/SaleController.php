...
class SaleController extends Controller
{
    ...
    {      
        ...
        if($role->hasPermissionTo('sales-index')) {
            ...
            return view('App_sale.index',compact('lims_sale_all', 'lims_gift_card_list', 'lims_pos_setting_data', 'lims_account_list', 'all_permission'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('sales-add')){
            ...
            return view('App_sale.create',compact('lims_customer_list', 'lims_warehouse_list', 'lims_biller_list', 'lims_pos_setting_data', 'lims_tax_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
