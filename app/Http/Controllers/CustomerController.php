...
class CustomerController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('customers-index')){
            ...
            return view('App_customer.index', compact('lims_customer_all', 'all_permission'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('customers-add')){
            ...
            return view('App_customer.create', compact('lims_customer_group_all'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('customers-edit')){
            ...
            $lims_customer_group_all = CustomerGroup::where('is_active',true)->get();
            return view('App_customer.edit', compact('lims_customer_data','lims_customer_group_all'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
